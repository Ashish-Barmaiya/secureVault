...
export default function Hero() {
  ...
  return (
    <section className="relative px-4 pt-32 pb-20 sm:pt-40 sm:pb-32 lg:pt-48 lg:pb-40 overflow-hidden bg-[#0f172a]">
      {/* Background effects */}
      ...
      <div className="relative max-w-7xl mx-auto z-10 grid lg:grid-cols-2 gap-12 items-center">
        <div className="text-left">
          ...
          <p className="text-lg text-slate-400 max-w-xl leading-relaxed mb-10">
            The world's most secure vault for your crypto assets, financial
            data, and critical documents. Encrypted with AES-256 and accessible
            only by you and your trusted heirs.
          </p>
